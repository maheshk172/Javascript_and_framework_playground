...
var chromeExec = function() {
    switch(process.platform) {
        case 'win32':
            return "chromedriver-2.20.exe";
        case 'darwin':
            return  'chromedriver-mac32-2.20';
        case 'linux':
            return 'chromedriver-linux-2.20';
        default:
            return 'chromedriver_2.20.exe';
    }
}


var bankingapphost = 'http://localhost:8080';
...
exports.config = {
    ...
    chromeDriver: path.resolve(__dirname, '../test/selenium/' + chromeExec()),
    ...
    capabilities: {
        'browserName': 'chrome',
        chromeOptions: {
            'args': ['--disable-extensions', '--allow-running-insecure-content', '--disable-setuid-sandbox']
        },
        loggingPrefs: {
            browser: 'ALL'
        },
    ...
    params: {
        bankingapphost: '<%= bankingapphost %>'
    },

    // If set, protractor will save the test output in json format at this path.
    // The path is relative to the location of this config.
    //resultJsonOutputFile: 'build/reports/protractor/protractor_output.json',
    ...
    cucumberOpts: {
        // Require files before executing the features_ui.
        require: ['../test/features/step_definitions/*.steps.js'],
        // Only execute the features_ui or scenarios with tags matching @dev.
        // This may be an array of strings to specify multiple tags to include.
        tags: [],
        // How to format features_ui (default: progress)
        format: 'pretty'
    }
};
